...
;(function($){
	 ...
	 */
	$.fn.flatUnmask = function(){
		$(this).each(function() {
			$.flatUnmaskElement($(this));
		});
	};
	...
	$.flatMaskElement = function(element, label){
		...
		if(label !== undefined) {
			...
			maskMsgDiv.append('<div class="flat-icon"></div>');
	...
	$.flatUnmaskElement = function(element){
